...
def t2h(T, t):
	...
	# 1. Initialize a 3x3 Identity matrix
    Th = np.eye(3)
    
    # 2. Insert the 2x2 transformation matrix into the top-left block
    Th[0:2, 0:2] = T
    
    # 3. Insert the translation vector into the first two rows of the last column
    Th[0:2, 2] = t
    #------------------------------------------------------------------#
    return Th
